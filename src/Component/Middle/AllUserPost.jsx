...
const AllUserPost = ({ userPost, isPending, error }) => {
  ...
  if (!userPost) {
    return (
      <div className="min-h-64 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center rounded-2xl shadow-xl">
        <p className="text-gray-700 text-xl font-semibold">No post data available.</p>
      </div>
    );
  }
